class ApiList {
  static const baseUrl = "https://demo.storeking.xyz";
  static const licenseCode = "i9u99tt4-f0w6-71w7-8394-y968t02516r11";
  static const mapApiKey = "AIzaSyCvcM-InOL7WIDVwDv3sGyxGJwPtAQ3Ei0";
  ...
  static String getCallingCode({required String countryCode}) =>
      "$baseUrl/api/frontend/country-code/show/$countryCode";
  ...
  static String checkDeliveryZone({
    ...
    required String longitude,
      ...
      "$baseUrl/api/frontend/check-delivery-zone?id=$addressId&user_id=$userId&label=$label&address=$address&latitude=$latitude&longitude=$longitude";
}
