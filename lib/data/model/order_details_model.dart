...
class Data {
  ...
  dynamic posPaymentNote;
  dynamic editedAmount;
  String? editedCurrencyAmount;
  dynamic transaction;
  DateTime? editedDate;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    shippingChargeCurrencyPrice = json['delivery_charge_currency_price'];
    returnOrderNote = json["return_order_note"];
    ...
    source = json['source'];
    active = json['active'];
    editedAmount = json["edited_amount"];
    editedCurrencyAmount = json["edited_currency_amount"];
  ...
  Map<String, dynamic> toJson() {
    ...
    data["edited_amount"] = this.editedAmount;
    data["edited_currency_amount"] = editedCurrencyAmount;
