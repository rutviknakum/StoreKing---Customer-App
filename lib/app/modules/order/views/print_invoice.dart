...
import 'package:ebazaar/data/model/order_details_model.dart' as order;
import 'package:ebazaar/data/model/setting_model.dart' as info;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          "${"Tel:".tr} ${widget.comapnyInfo!.companyPhone.toString()}",
                          textAlign: TextAlign.center,
                          style: GoogleFonts.ptSans(
                              color: AppColor.textColor,
                              fontWeight: FontWeight.w400,
                              ...
                              Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      widget.orderDetails?.transaction != null
                                          ? widget.orderDetails!.editedAmount !=
                                                      0 &&
                                                  widget.orderDetails!
                                                          .transaction !=
                                                      0
                                          ...
                                          : const SizedBox(),
                                      SizedBox(height: 6.h),
                                      widget.orderDetails?.returnOrderNote !=
                                                  null &&
                                              widget.orderDetails?.status == 25
                                          ? Row(
                                              children: [
                                                Text(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      widget.orderDetails?.transaction != null
                                          ...
                                          : const SizedBox(),
                                      SizedBox(
                                          height: widget.orderDetails?.reason !=
                                                      null &&
                                                  widget.orderDetails?.status ==
                                                      25
                                              ? 6.h
                                              : 0.h),
                                      widget.orderDetails?.reason != null &&
                                              widget.orderDetails?.status == 25
                                          ? TextWidget(
                                              text: widget.orderDetails?.reason,
                                              maxLines: 1,
                                              color: AppColor.textColor,
                                              fontSize: 12.sp,
                                  ...
                                  : Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            widget.orderDetails!.user!
                                                    .countryCode
                                                    .toString() +
                                                widget.orderDetails!.user!.phone
                                                    .toString(),
                                            style: GoogleFonts.ptSans(
                                                color: AppColor.textColor,
                                                fontWeight: FontWeight.w400,
