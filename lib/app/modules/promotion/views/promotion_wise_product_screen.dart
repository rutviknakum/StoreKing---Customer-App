...
import '../../home/controller/promotion_controller.dart';
import '../../home/model/promotion_model.dart';
                                  ...
                                  if (box.read('isLogedIn') != false) {
                                    if (data[index].wishlist == true) {
                                      await wishlistController
                                          .toggleFavoriteFalse(data[index].id!);
                                      wishlistController
                                          .showFavorite(data[index].id!);
                                    }
                                    if (data[index].wishlist == false) {
                                      await wishlistController
                                          .toggleFavoriteTrue(data[index].id!);
                                      wishlistController
                                          .showFavorite(data[index].id!);
                                    }
                                  } else {
