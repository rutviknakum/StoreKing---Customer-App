...
import 'package:ebazaar/app/modules/payment/widgets/payment.dart';
                    ...
                    Obx(
                      () => OrderSummay(
                        ...
                        shippingCharge: widget.isDelivery == false ||
                                showAddressController.zoneStatus.value == false
                            ? "0"
                          ...
                          if (paymentController.paymentMethodIndex.value ==
                            ...
                            if (paymentController
                              ...
                              if (profileController.accountBalance.value >
                                  (cartController.totalPrice > 0 && couponController.applyCouponStatus.value == true
                                      ? ((cartController.totalPrice +
                                                  cartController.totalTax +
                                                  (widget.isDelivery == false ||
                                                          showAddressController
                                ...
                                paymentController.confirmOrder(
                                  ...
                                  total: cartController.totalPrice > 0 &&
                                          couponController.applyCouponStatus.value ==
                                              true
                                      ? ((cartController.totalPrice + cartController.totalTax) +
                                              (widget.isDelivery == false || showAddressController.zoneStatus.value == false
                                                  ? 0
                                                  : cartController
                                                      .deliveryCharge)) -
                                          (double.parse(couponController
                                  ...
                                  billingId: widget.isDelivery == true
                                      ? showAddressController
                                          ...
                                          : showAddressController
                                              ...
                                              .toInt()
                                      : 0,
                                  outletId: widget.isDelivery == false
                                      ? showAddressController
                                          .outlestModel
                                          .value
                                          .data![showAddressController
                                              .selectedOutletIndex.value]
                                          .id!
                                          .toInt()
                                      : 0,
                                  couponId: couponController
                                          .applyCouponModel.value.data?.id
                                          ?.toInt() ??
                                      0,
                                  orderType:
                                      widget.isDelivery == false ? 10 : 5,
                                  source: 10.toInt(),
                                  ...
                                  images:
                                      showAddressController.imageList.toList(),
                                );
                              } else {
                              ...
                              paymentController.confirmOrder(
                                ...
                                shippingCharge: widget.isDelivery == false ||
                                        showAddressController
                                            ...
                                            false
                                    ? 0
                                    : double.parse(cartController.deliveryCharge
                                        .toStringAsFixed(2)),
                                tax: cartController.totalTax,
                                total: cartController.totalPrice > 0 &&
                                        couponController.applyCouponStatus.value ==
                                    ...
                                    : ((cartController.totalPrice + cartController.totalTax) +
                                        (widget.isDelivery == false ||
                                                showAddressController.zoneStatus.value == false
                                            ? 0
                                            : double.parse(cartController.deliveryCharge.toStringAsFixed(2)))),
                                shippingId: widget.isDelivery == true
                                    ? showAddressController
                                        .addressList
                                        .value
